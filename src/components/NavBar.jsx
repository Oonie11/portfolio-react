...
const NavBar = () => {
  ...
  return (
    <div className="navContainer flex justify-between items-center w-full h-16 text-white bg-black px-4 fixed">
      <div>
        <h1 className="text-4xl font-signature ml-2">
          {" "}
          Utka<span className="text-blue-400">r</span>sh Patel
        </h1>
      </div>
